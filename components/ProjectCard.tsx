      ...
      >
        ...
        >
          ...
          >
            ...
            {/* right: Text Section */}
            <div className="flex-1 flex flex-col justify-between space-y-4 order-2 md:order-1">
          ...
          <motion.div
            ...
            className="absolute bottom-3 right-6 flex items-center gap-2 text-primary text-sm font-medium"
          >
